...
CREATE TABLE `report_details` (
  ...
  CONSTRAINT `report_details_ibfk_1` FOREIGN KEY (`report_id`) REFERENCES `reports` (`id`) ON DELETE CASCADE,
  CONSTRAINT `report_details_ibfk_2` FOREIGN KEY (`training_point_id`) REFERENCES `training_points` (`id`) ON DELETE CASCADE
